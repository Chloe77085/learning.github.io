...
![](./images/openclawimage/openclawimage1.png)

**2. 创建 API Key**
1. 在开放平台中，进入 **账号管理** > **接口密钥** > **创建新的 API Key**。
![](./images/openclawimage/openclawimage2.png)
1. 填写密钥名称（任意即可），点击 **创建新的密钥**。
![](./images/openclawimage/openclawimage3.png)

1. **重要：** 密钥创建后只展示一次，无法再次查看。请务必立即将密钥复制保存到本地安全位置，后续安装配置时需要多次使用。
![](./images/openclawimage/openclawimage4.png)

创建完成后效果如下：
![](./images/openclawimage/openclawimage5.png)
:::note
想激活免费额度，需要在平台进行认证。
:::
![](./images/openclawimage/openclawimage6.png)
...
npm -v
```
![](./images/openclawimage/openclawimage7.png)
...
```
![](./images/openclawimage/openclawimage8.png)
...
安装过程截图：
![](./images/openclawimage/openclawimage9.png)
![](./images/openclawimage/openclawimage10.png)
![](./images/openclawimage/openclawimage11.png)
...
1. 下载完成后，将来到安装界面，此处选择【Yes】并回车：
   ![](./images/openclawimage/openclawimage13.png)
2. 【Onboarding mode】 选择【QuickStart】并回车；
   ![](./images/openclawimage/openclawimage14.png)
3. 【Model/auth provider】 选择【MiniMax】并回车；
   ![](./images/openclawimage/openclawimage15.png)
4. 【MiniMax auto method】选择【Minimax M2.1】并回车；
   ![](./images/openclawimage/openclawimage16.png)
5. 【Enter MiniMax API key】输入在MiniMax中生成的API Key 并回车；
   ![](./images/openclawimage/openclawimage17.png)
6. 【Default model】选择【Keep Current】；
   ![](./images/openclawimage/openclawimage18.png)
7. 由于条件限制，暂时无法使用下述应用，所以选择【skip for now】，后面可在web端中重新配置；
   ![](./images/openclawimage/openclawimage19.png)
8. 【Configure skills now】 选择【No】，后面可在web端中重新配置；
   ![](./images/openclawimage/openclawimage20.png)
9. 【Enable hook】将下面三个用空格勾选上并回车，进行安装（若无 Hooks 选项，后续也可在 web 中重新配置）；
    ![](./images/openclawimage/openclawimage21.png)
    ![](./images/openclawimage/openclawimage22.png)
10. 【Install shell completion script】选择【Yes】并回车，此时OpenClaw安装完成；
    ![](./images/openclawimage/openclawimage23.png)
安装完成后，检查 OpenClaw 状态：
```JSON
openclaw status 
```
![](./images/openclawimage/openclawimage24.png)
...
![](./images/openclawimage/openclawimage25.png)
...
![](./images/openclawimage/openclawimage27.png)
...
![](./images/openclawimage/openclawimage28.png)
...
![](./images/openclawimage/openclawimage29.png)
![](./images/openclawimage/openclawimage30.png)
### 8. 常用命令速查
| 命令 | 说明 |
| :--- | :--- |
...
cd openclaw 
```
![](./images/openclawimage/openclawimage32.png)
进入项目目录：
![](./images/openclawimage/openclawimage33.png)
打开终端：
![](./images/openclawimage/openclawimage34.png)

#### 第 3 步：安装依赖
```JSON
pnpm install
```
![](./images/openclawimage/openclawimage35.png)
![](./images/openclawimage/openclawimage36.png)

#### 第 4 步：构建 UI
```JSON
pnpm ui:build
```
![](./images/openclawimage/openclawimage37.png)

#### 第 5 步：构建项目
```JSON
pnpm build 
```
![](./images/openclawimage/openclawimage38.png)
...
![](./images/openclawimage/openclawimage39.png)
...
操作步骤截图：
![](./images/openclawimage/openclawimage40.png)
![](./images/openclawimage/openclawimage41.png)
![](./images/openclawimage/openclawimage42.png)
![](./images/openclawimage/openclawimage43.png)
...
![](./images/openclawimage/openclawimage53.png)
...
![](./images/openclawimage/openclawimage47.png)
...
3. 添加回调：**卡片回传交互**。
![](./images/openclawimage/openclawimage48.png)

## 6. 发布与测试
1. 在飞书开发者后台，进入 **版本管理与发布**。
2. 创建新版本并提交发布。
![](./images/openclawimage/openclawimage49.png)
3. 审核通过后，在飞书中搜索你的机器人即可开始对话！
|![](./images/openclawimage/openclawimage50.png)|![](./images/openclawimage/openclawimage50.png)|
